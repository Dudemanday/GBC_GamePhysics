...
public:
	...
	static bool circleBoxCheck(SDL_Rect circle, SDL_Rect rect);
	...
	//static bool lineAABBCheck(Brick* object1, GameObject* object2);
	...
	static bool circleCircleCheck(glm::vec2 pos1, glm::vec2 pos2, float r1, float r2);
private:
	CollisionManager();
	~CollisionManager();
};
